...
import PlaylistKelas from './components/PlaylistKelas.jsx';
...
export default function App() {
  ...
  const { counts: likeCounts, likedSet, toggleLike, pendingSet: likePendingSet } = useSiswaLikes();
  ...
  return (
    <>
      ...
      <KomentarModal
        ...
        onToggleLike={toggleLike}
        likePendingSet={likePendingSet}
        komentarPendingSet={komentar.pendingSet}
      />
