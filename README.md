...
service cloud.firestore {
  match /databases/{database}/documents {
    ...
    // Data dashboard pengurus kelas (/private-pr-kelas) — SEMUA tertutup
    // total dari client, cuma serverless function (Firebase Admin SDK) yang
    // boleh baca/tulis, dan itu pun sudah diverifikasi token sesi pengurus
    // dulu di dalam kodenya (lihat api/verify-officer-key.js, api/tugas.js,
    // api/kas.js). Ini yang bikin data tugas/PR dan kas kelas benar-benar
    // privat — tidak seperti komentar/menfess yang memang publik.
